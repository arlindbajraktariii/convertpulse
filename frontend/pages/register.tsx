...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Don't set onboarding_completed - let the dashboard modal show it
  ...
  return (
    <>
      <Head>
        <title>Register - Guesswhere</title>
      </Head>
  <div className="min-h-screen flex items-center justify-center px-4 bg-[#FBFBFB]">
      ...
      <div className="w-full max-w-md relative z-10 mt-16">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-bold mb-3 text-gray-900">Get started free</h1>
          <p className="text-gray-600">Create your account and start tracking conversions</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 mb-6">
          ...
          {/* Sign In Link */}
          <Link href="/login" className="block w-full text-center py-2 text-gray-600 hover:text-black font-medium transition-colors">
            Sign in instead
          </Link>
        </div>
